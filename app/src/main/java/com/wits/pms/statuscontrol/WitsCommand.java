...
public class WitsCommand {
    ...
    public static WitsCommand getWitsCommandFormJson(String str) {
        return (WitsCommand) new Gson().fromJson(str, WitsCommand.class);
    }

    public WitsCommand(int i, int i2, String str) {
        this.command = i;
        this.subCommand = i2;
        this.jsonArg = str;
    }

    public WitsCommand(int i, int i2) {
        this.command = i;
        this.subCommand = i2;
    }
