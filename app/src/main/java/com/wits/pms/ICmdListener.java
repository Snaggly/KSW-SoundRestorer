...
public interface ICmdListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICmdListener {
        ...
        public static ICmdListener asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface == null || !(queryLocalInterface instanceof ICmdListener)) {
                return new Proxy(iBinder);
            }
            return (ICmdListener) queryLocalInterface;
        }
            ...
            if (i != 1598968902) {
                switch (i) {
                    case 1:
                        ...
                        boolean handleCommand = handleCommand(parcel.readString());
                        parcel2.writeNoException();
                        parcel2.writeInt(handleCommand ? 1 : 0);
                        return true;
                    case 2:
                        parcel.enforceInterface(DESCRIPTOR);
                        updateStatusInfo(parcel.readString());
                        parcel2.writeNoException();
                        return true;
                    default:
        ...
        private static class Proxy implements ICmdListener {
            ...
            public boolean handleCommand(String str) throws RemoteException {
            ...
            public void updateStatusInfo(String str) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken(Stub.DESCRIPTOR);
